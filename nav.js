(function () {
  ...
  var PROJECTS = [
    ...
    { label: 'Cleo Daisy',  href: '/cleo-daisy/',     img: '/assets/cleo/cleohero.png',   cat: 'Fashion Editorial \u00b7 Concept Project',       desc: 'Art direction, typography, and interaction — with full creative freedom.' },
  ];
