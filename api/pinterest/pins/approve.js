...
module.exports = async (req, res) => {
  ...
  // Reject approval if the stored destinationUrl is not a valid Pink Web Studio URL
  const urlCheck = validateDestinationUrl(drafts[idx].destinationUrl);
  if (!urlCheck.valid) {
  ...
  res.end(JSON.stringify({ ok: true, id, status: 'approved' }));
};
